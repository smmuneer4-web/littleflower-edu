        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a href="https://www.youtube.com/channel/UCUmEiGqj4yw8edx3IVov66w" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-800 hover:bg-emerald-600 rounded-lg flex items-center justify-center transition-colors">
                <Youtube size={18} />
              </a>
              <a href="https://www.instagram.com/littleflowergroupofficial/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-800 hover:bg-emerald-600 rounded-lg flex items-center justify-center transition-colors">
                <Instagram size={18} />
              </a>
              <a href="https://www.facebook.com/Littleflowergroupofficial" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-800 hover:bg-emerald-600 rounded-lg flex items-center justify-center transition-colors">
                <Facebook size={18} />
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <button onClick={() => scrollToSection('courses')} className="hover:text-emerald-400 transition-colors">
                  Find Your Course
                </button>
              </li>
              <li>
          ...
          <div>
            ...
            {institutions.map((campus, index) => (
              <div key={index} className="mb-4">
                <h5 className="text-emerald-400 font-semibold text-sm mb-2">{campus.campus}</h5>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li className="flex gap-3">
                ...
                <a href={`tel:${heroData.contactInfo.phone}`} className="hover:text-emerald-400 transition-colors">
                  {heroData.contactInfo.phone}
                </a>
              </li>
              <li className="flex gap-3">
                <Mail size={18} className="text-emerald-400 flex-shrink-0 mt-1" />
                <a href={`mailto:${heroData.contactInfo.email}`} className="hover:text-emerald-400 transition-colors break-all">
